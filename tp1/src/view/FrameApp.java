...
public class FrameApp extends javax.swing.JFrame {
    ...
    public FrameApp() {
        ...
        // If it's the first time you're starting the application, 
        // set this variable that will be used to check whether or not to display an alert
        this.openNow = true;
    ...
    It will be called when clicking on a line and pressing the del button.
    Thus, I retrieve the id of the clicked row, based on the database and remove
    this id from the table
    
    @param uuid to remove
     */
    private void removerLinha(UUID uuid) {
        int option = JOptionPane.showConfirmDialog(null,
                "Deseja excluir a entrada mesmo?",
                "Excluir",
    ...
    /*
        ...
        when called, it gets a database instance, with these updated, 
        and then fills the entire table with the formatted data.
     */
    private void preencherTabela() {
        finances = financeController.getAllFinances();

        // if there is no data in the table and it is the first time you open 
        // the program, then it displays the alert
        if (finances.isEmpty()) {
            alertNoData();
        } else {
            this.openNow = false;
    ...
    /*
    Displays the data or hides them, if there is or not data from entries
    ...
    it retrieves the input data and registers them, in addition, 
    it checks if the two fields, expense or receipt are marked, if they are,
    it does not allow the registration.
     */
